...
def build_yolo_dataset(
    ...
    Honors multilabel datasets if `cfg.multilabel` is True, otherwise uses multi-modal
    or standard YOLO datasets based on `multi_modal`.
    """
    if getattr(cfg, "multilabel", False):
